...
Fourteen pictures land in `ios/App/out`: a game under way, a board straight off a photograph, one
...
from the piece that would come to it, a square taken and still not stood on, and the whole screen
at night. They are not in the repository — they are written to be looked at, and they are rewritten by every
run.
